...
/*
3.	Розробити клас, в якому агрегуються об’єкти класу, розробленого на лабораторній роботі 2,
    у вигляді колекції інтерфейсного типу Map. В цьому класі розробити методи, які надають можливість (30 балів):
    •	фільтрувати об’єкти колекції за вибраною ознакою,
    •	видаляти з колекції об’єкти,  які не відповідають заданому критерію,
    •	визначати для колекції суму (або іншу операцію reduction) заданої кількісної ознаки.
4.	Розробити метод для сортування об’єктів послідовно за кількома вибраними ознаками, використовуючи різні способи:
...
public class MapTaxiPark {
    ...
    public void printTaxiParkInfoBrief() {
        cars.values().forEach(Taxi::taxiInfo);
    }
    public void printTaxiParkInfo() {
        cars.values().forEach(Taxi::info);
    }
    ...
    public static void main(String[] args) {
        MapTaxiPark taxiPark = new MapTaxiPark(4);
